...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { image: @slide.image, lecture_id: @slide.lecture_id, order: @slide.order } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { image: @slide.image, lecture_id: @slide.lecture_id, order: @slide.order } }
